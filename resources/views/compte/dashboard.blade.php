                    ...
                    <div class="row">
                        <div class="col-lg-3 mb30">
                            <div class="card p-4 rounded-5">
                                ...
                                <ul class="menu-col">
                                    <li><a href="{{ route('Dashboard.index') }}" class="active"><i class="fa fa-home"></i>Tableau de bord</a></li>
                                    <li><a href="{{ route('Monprofile.index') }}"><i class="fa fa-user"></i>Mon Profil</a></li>
                                    <li><a href="{{ route('Maliste.index') }}"><i class="fa fa-calendar"></i>Ma liste</a></li>
