...
@section('content')
        ...
        <div class="no-bottom no-top zebra" id="content">
            ...
            <section aria-label="section" class="jarallax text-light">
                <img src="assets/images/background/8.jpg" class="jarallax-img" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
            ...
            <section id="section-img-with-tab">
                ...
                <div class="image-container col-md-6 pull-right" data-bgimage="url(assets/images/background/5.jpg) center"></div>
            </section>
